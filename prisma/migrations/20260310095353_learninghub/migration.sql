...
CREATE TABLE "UserSettings" (
    ...
    "courseLanguage" TEXT,
    "freeContentOnly" BOOLEAN NOT NULL DEFAULT false,
    "aiResponseDetail" TEXT,
    "aiResponseLanguage" TEXT,
    "aiExplainReasoning" BOOLEAN NOT NULL DEFAULT false,
    "aiRecommendationMode" TEXT,
    "notifyWeeklyRecs" BOOLEAN NOT NULL DEFAULT true,
    "notifyCertExpiry" BOOLEAN NOT NULL DEFAULT true,
    "notifyProgress" BOOLEAN NOT NULL DEFAULT true,
    "notifyByEmail" BOOLEAN NOT NULL DEFAULT true,
    "notifyInApp" BOOLEAN NOT NULL DEFAULT true,
    "adminCanSeeRecs" BOOLEAN NOT NULL DEFAULT true,
    "aiCanUseHistory" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
